    ...
    if usr_cmd == "/start":
        ...
        if(Config.LAZY_MODE == True):
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/k2m_movies_series"),
                        InlineKeyboardButton("🔊ß⊕†s chαηηεl", url="https://t.me/+UngOD0DOsQVjNjRl")
                    ],
                    [
                    ...
                    [
                        InlineKeyboardButton("⎝⎝✧✧ ᴡᴀᴛᴄʜ ᴛᴜᴛᴏʀɪᴀʟ ✧✧⎠⎠", url="https://t.me/Acckerman_offical")
                    ]]))
        else :
            await cmd.reply_photo(photo=lazy_pic,
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        InlineKeyboardButton("⎝⎝✧✧ ᴡᴀᴛᴄʜ ᴛᴜᴛᴏʀɪᴀʟ ✧✧⎠⎠", url="https://t.me/+UngOD0DOsQVjNjRl")
                    ]]))
...
async def main(bot: Client, message: Message):
    ...
    if message.chat.type == enums.ChatType.PRIVATE:
        ...
        if message.from_user.id in Config.BANNED_USERS:
            await message.reply_text("ꜱᴏʀʀʏ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ!\n\nContact [Support Group](https://t.me/chatgroupk2m)",
                                     disable_web_page_preview=True)
            return
    ...
    if "aboutbot" in cb_data:
        ...
        if(Config.LAZY_MODE == True):
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton("🍿supp⊕r† gr⊕up", url="https://t.me/chatgroupk2m"),
                        InlineKeyboardButton("🔊ß⊕ts Channel", url="https://t.me/+UngOD0DOsQVjNjRl")
                    ],
                    [
                        InlineKeyboardButton("🤖Aß⊕ut ß⊕t", callback_data="aboutbot"),
                        InlineKeyboardButton("♥️Aß⊕ut Đ€V", callback_data="aboutdevs")
                    ...
                    [
                        InlineKeyboardButton("⎝⎝✧✧ ᴡᴀᴛᴄʜ ᴛᴜᴛᴏʀɪᴀʟ ✧✧⎠⎠", url="https://t.me/chatgroupk2m")
                    ]
                ]
            )
        )
        ...
        if Config.UPDATES_CHANNEL:
            ...
            try:
                ...
                if user.status == "kicked":
                    await cmd.message.edit(
                        text="ꜱᴏʀʀʏ ꜱɪʀ, ʏᴏᴜ ᴀʀᴇ ʙᴀɴɴᴇᴅ ᴛᴏ ᴜꜱᴇ ᴍᴇ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/chatgroupk2m).",
                        disable_web_page_preview=True
                    )
                    return
                ...
                await cmd.message.edit(
                    text="ꜱᴏᴍᴇᴛʜɪɴɢ ᴡᴇɴᴛ ᴡʀᴏɴɢ. ᴄᴏɴᴛᴀᴄᴛ ᴍʏ [Support Group](https://t.me/chatgroupk2m).",
                    disable_web_page_preview=True
                )
                return
        if(Config.LAZY_MODE == True):
